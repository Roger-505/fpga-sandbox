...
void DI2s_LoopBack(DI2s *InstancePtr, u32 u32NrSamples,	u32 *PalybackAddr, u32* RecordAddr);
...
void DI2s_DmaLoopBack(DI2s *InstancePtr,XAxiDma *DMAInstPtr, u32 u32NrSamples, u32 SourceAddr, u32 DestAddr);
#endif

...
create_bd_cell -type ip -vlnv digilentinc.com:ip:dvi2rgb:1.7 $hier_name/dvi2rgb_0
...
set_property -dict [list CONFIG.kClkRange {1}] [get_bd_cells $hier_name/dvi2rgb_0]
set_property -dict [list CONFIG.kClkRange {1}] [get_bd_cells $hier_name/rgb2dvi_0]

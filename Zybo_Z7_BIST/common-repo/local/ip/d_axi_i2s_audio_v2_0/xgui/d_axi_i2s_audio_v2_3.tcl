...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set CLK_Control [ipgui::add_group $IPINST -name "CLK Control" -parent ${Page_0}]
  set_property tooltip {CLK Control} ${CLK_Control}
  ipgui::add_param $IPINST -name "ENABLE_LRCLK_2" -parent ${CLK_Control}
  ipgui::add_param $IPINST -name "OUTPUT_ONLY_CLK" -parent ${CLK_Control}
  ipgui::add_param $IPINST -name "INPUT_ONLY_CLK" -parent ${CLK_Control}



}

proc update_PARAM_VALUE.INPUT_ONLY_CLK { PARAM_VALUE.INPUT_ONLY_CLK PARAM_VALUE.OUTPUT_ONLY_CLK } {
...
proc update_MODELPARAM_VALUE.ENABLE_STREAM { MODELPARAM_VALUE.ENABLE_STREAM PARAM_VALUE.ENABLE_STREAM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ENABLE_STREAM}] ${MODELPARAM_VALUE.ENABLE_STREAM}
}
